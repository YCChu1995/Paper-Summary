### BGE
1. **retriever**: bge-large-en-v1.5
   - [2309.07597](https://arxiv.org/abs/2309.07597) C-Pack: Packaged Resources To Advance General Chinese Embedding
2. **re-ranker**:
   - [2312.15503](https://arxiv.org/abs/2312.15503) Making Large Language Models A Better Foundation For Dense Retrieval
   - [2402.03216](https://arxiv.org/abs/2402.03216) M3-Embedding: Multi-Linguality, Multi-Functionality, Multi-Granularity Text Embeddings Through Self-Knowledge Distillation
